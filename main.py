...
# ───────────────────────────────────────
# DEV MODE TO BYPASS LOGIN FOR TESTING
# ───────────────────────────────────────
DEV_MODE = True  # Set to False when you're ready to go live
...
with tab2:
    if DEV_MODE:
        st.success("🛠 Dev Mode: Full Sim Unlocked")
        run_full_sim()
...
with tab3:
    if DEV_MODE:
        show_sim_history("test@example.com")
    elif "user" in st.session_state:
